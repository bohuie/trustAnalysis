...
class TrustVizAnalytics:
    ...
    def cultural_background(self):
        results = self.results
        culback = results['Cultural Background'].str.split(',').explode('Cultural Background').value_counts()
    ...
    def accuracy_class(self):
        ...
        answers = "Most teams seem to have a good spread of members with different majors."
    ...
    def combine_accuracy(self):
        ...
        result = pd.concat([acc_skill['skill_accuracy'], acc_team['team_accuracy'], acc_class['class_accuracy']], axis=1)
